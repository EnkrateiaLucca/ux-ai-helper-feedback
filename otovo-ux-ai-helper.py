...
if uploaded_file:
    ...
    system_message = st.sidebar.text_input("""            You are a UX designer for a solar panel company 
            ...
            same brand language.""", "Please provide the data for the image.")
    
    prompt = st.text_area("""""", "Describe the Prompt for the UX Helper.")
